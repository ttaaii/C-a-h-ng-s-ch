...
$connect = mysqli_connect("localhost","root","","sinhvien2021") or die('Not connect');
...
if (isset($_POST['submit'])) {
  ...
  $sql= "INSERT INTO books (title, author, price, mota,hinhanh) VALUES ('$title', '$author', $price, '$mota','$hinhanh')";
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div id="editor"></div>
	...
	<tr>	 
 <td> <input type="submit" name="submit"  value="Thêm sách mới" ></td>
