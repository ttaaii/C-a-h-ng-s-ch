...
<div class="w3-main" style="margin-left:250px">
  ...
  <h1>Sách</h1>
    <?php
            ...
            echo "<h3>Tiêu đề: ".$row['title'].'</h3>';
            echo "<p>Tác giả: ".$row['author'].'</p>';
            echo "<p>Mô tả: ".$row['mota'].'</p>';
            echo "<p>Giá sách: ".number_format($row['price'],3)."VND</p>";
            echo '<p >'.  "<img src = ".$row['hinhanh'].' width="200" height="290"'.  '></td>';
            echo "<p><a href='addcart.php?item=$row[id]'>Mua Sach Nay</a></p>";
    ...
    <div id="dsbinhluan">
        <?php
            $conn1 = mysqli_connect("localhost", "root", "", "sinhvien2021");
            $sql1 ="SELECT * FROM binhluan WHERE idbook=".$_GET['id'];
    ...
    <div id="binhluan">
            <input type="hidden" id="idbook" value="<?php echo $row['id']; ?>">
            <input type="text" id="noidung">
            <input type="submit" value="Gửi" id="btgui">
    </div>
  </div>
  <br>
 <a href="index.php"><input type="button" value="Mua sách tiếp"></a><BR></BR>
 <p></p>
  <!-- Subscribe section -->
