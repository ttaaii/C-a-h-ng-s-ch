...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-grayscale">
    ...
    Chúc mừng bạn <?php echo $_SESSION['username'];  ?> đã đăng nhập thành công !
    ...
    <?php
            ...
            foreach($_SESSION['cart'] as $k=>$v)
        {
         ...
         {
            $items = $_SESSION['cart'];
            echo '<td>Ban dang co <a href="cart.php">'.count($items).' mon hang trong gio hang</a></td>';
         }
?>
<table border="1">
<?php
    ...
    {
        echo "<tr>";
        echo '<td><a href="sach.php?id= '.$row['id'].'">'.$row['title'].'</a></td>';
        echo "<td>Tac Gia: $row[author]<p> Gia: ".number_format($row['price'],3)."VND</p></td><br/>";
        echo '<td>'.  "<img src = ".$row['hinhanh'].' width="200" height="290"'.  '></td>';
        echo "<td><a href='addcart.php?item=$row[id]'>Mua Sach Nay</a></td>";
        echo "</tr>";
    }
    }
?>
