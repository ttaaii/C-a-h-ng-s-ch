...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql= "INSERT INTO donhang(idkhachhang, ngaymua, tongtien, trangthai) VALUES ('$idkhachhang', '$ngaymua', $tongtien, '$trangthai')";
    //UPDATE
...
<div class="w3-main" style="margin-left:250px">
  ...
  <h1>Cập nhật trạng thái mua hàng	</h1>
	<?php
		$conn2 = mysqli_connect("localhost", "root", "", "sinhvien2021");
	...
	<form action="" method="POST">
		<tr>
            <td>Khách hàng</td>
            <td><input type="text" name="idkhachhang" value="<?php echo $thongtin['idkhachhang']; ?>" size="40"></td>
        </tr><tr>
            <td>Ngày mua</td>
            <td> <input type="text" name="ngaymua" value="<?php echo $thongtin['ngaymua']; ?>" size="40"></td>
        </tr><tr>
            <td>Tổng tiền</td>
            <td><input type="text" name="tongtien" value="<?php echo $thongtin['tongtien']; ?>" size="40"></td>
        </tr>
        <tr>
           <td> Lớp sinh hoạt: </td>
        ...
        <tr>
            <td colspan="2" > <input  type="submit" value="Cập nhật trạng thái đơn hàng"></td>
