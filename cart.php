...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <a href="dangxuat.php"><h6>Đăng xuất</h6></a>
  </div>
        ...
        if($ok == 2)
{
            ...
            while($row=mysqli_fetch_array($query))
    {
        ...
        echo "<p align='right'> Giá tiền cho món hàng: ".number_format($_SESSION['cart'][$row['id']]*$row['price'],3)." VND</p>";
        echo "</div>";
        $total += $_SESSION['cart'][$row['id']]*$row['price'];    
    }
        echo "<div class='pro' align='right'>";
        echo "<b>Tổng tiền cho các món hàng: <font color='red'>".number_format($total,3)." VND</font></b>";
        // lưu session tổng tiến
        $_SESSION['total'] = $total;
        
        ?>
      <a href="donhang.php" > <p> <input type="button" value="Mua hàng"></p></a>
        <?php

        echo "</div>";
        echo "<input type='submit' name='submit' value='Cập nhật giỏ hàng'>";
        echo "<div class='pro' align='center'>";
        echo "<b><a href='index.php'>Mua Sách Tiếp</a> - <a href='delcart.php?productid=0'>Xóa bỏ giỏ hàng</a></b>";
        echo "</div>";
}
else
{
        echo "<div class='pro'>";
        echo "<p align='center'>Bạn không có món hàng nào trong giỏ hàng <br/><a href='index.php'>Buy Ebook</a></p>";
        echo "</div>";
}
?>
