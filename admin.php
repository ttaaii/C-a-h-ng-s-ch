...
<div class="w3-main" style="margin-left:250px">
  ...
  <h2>Danh sách tài khoản</h2>
				...
				while ($row = mysqli_fetch_array($ketqua)) 
					{
						echo "<tr>";
						echo "	<td>".$stt."</td>";
						echo '	<td><a href=" dstaikhoan.php?id= '.$row['id'].'">'.$row['username'].'</a></td>';
						echo '</tr>';
						$stt++;
					}
			?>	
				...
				while ($row = mysqli_fetch_array($ketqua)) 
					{
						echo "<tr>";
						echo "	<td>".$stt."</td>";
						echo '	<td><a href=" dsdonhang.php?id= '.$row['id'].'">'.$row['idkhachhang'].'</a></td>';
						echo '</tr>';
						$stt++;
					}
			?>	
	...
	<h2><a href="themsanpham.php">Thêm sản phẩm</a></h2>
