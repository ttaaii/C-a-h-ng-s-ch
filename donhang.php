...
<div class="w3-main" style="margin-left:250px">
  ...
  <table>
	...
	<tr> <td>Khách hàng</td>
	<td>   
    <input type="text" name="idkhachhang" id="idkhachhang" value="<?php echo $_SESSION['username'] ?>" size="30"></td>
	</tr>
	<tr> 	<td>Ngày mua</td>
	<td><input type="text" name="ngaymua" value="<?php echo date('Y-m-d') ?>" size="30"></td>
	</tr>
	<tr> 	<td>Tổng tiền</td>
	<td><input type="text" name="tongtien" value="<?php echo $_SESSION['total']  ?>" size="30"></td>
	</tr>
	<tr> 	<td>Trạng thái</td>
	<td><input type="text" name="trangthai" value="Chưa thanh toán" size="30"></td>
	</tr>
	<tr>	          
	<td ><input type="submit" value="Xác nhận mua hàng"></td>
	</tr>
